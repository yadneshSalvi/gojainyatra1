...
urlpatterns = [
    ...
    path('user_bookings/<username>/<year>/<month>/<day>/<hour>/<minute>/<second>/',views.user_bookings_descp,name='user_bookings_descp'),
    ...
    path('dharamshala/<slug:slug>/vlogs/<year>/<month>/<day>/<hour>/<minute>/<second>/<username>/<vlog_pk>/edit/',views.VlogUpdateView.as_view(),name='edit_vlog'),
