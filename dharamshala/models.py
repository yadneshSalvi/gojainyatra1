...
class Voucher(models.Model):
    ...
    dharamshala_address = models.TextField(max_length=500,blank=True,null=True)
    phone_of_dharamshala_or_bunglow_or_sanatorium = models.CharField(max_length=50,blank=True,null=True,default="-")
    email_of_dharamshala_or_bunglow_or_sanatorium = models.CharField(max_length=100,blank=True,null=True,default="-")
    check_in_time_given_by_dharamshala = models.CharField(max_length=400, blank=True,null=True,default="-")
    check_out_time_given_by_dharamshala = models.CharField(max_length=400, blank=True,null=True,default="-")
    yatri_email = models.EmailField(blank=True,null=True)
    yatri_phone = models.CharField(max_length=35)
    yatri_address = models.CharField(max_length=500, blank=True, null=True,default="-")
    ...
    check_in_time_given_by_yatri = models.CharField(max_length=400, blank=True,null=True,default="-")
    check_out_time_given_by_yatri = models.CharField(max_length=400, blank=True,null=True,default="-")
    ...
    service_charge = models.CharField(max_length=100,blank=True,null=True,default="-")
    ...
    gojainyatra_email_id = models.CharField(max_length=400,blank=True,null=True,default="-")
    gojainyatra_phone_no = models.CharField(max_length=50,blank=True,null=True,default="-")
